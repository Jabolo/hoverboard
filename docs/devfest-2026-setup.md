...
Campaign links are maintained in the canonical [DevFest 2026 — UTM Campaign Registry](./utm-campaign-registry.md). Use its ready-made links for LinkedIn, Instagram, newsletters, Bevy, and partner placements; do not create parallel UTM conventions in source code.
